...
class fmanager:
    ...
    def makedir(self, name):
        try:
            ...
            return "Неправильное имя каталога"
    ...
    def removedir(self, name):
        try:
            ...
            return "Этот каталог не существует по этому пути"
        return True
    #3
    def changedir(self, name):
        if name == "*up":
            if self.current_path == self.first_path:
                return "Вы не можете выйти из рабочей папки"
            else:
                os.chdir(self.first_path)
        else:
            try:
    ...
    def readfile(self, name):
        try:
            ...
            return "Этот файл не существует"
    ...
    def copyfile(self, filename, dirname):
        try:
            ...
            return "Этот файл или каталог не существует"
...
def handle_ftp_request(act: str, session):
    ...
    #for i in range(len(act)):
     # if i > 0:
      #  act_steps.append(act[i])
      #else:
       # act_steps.append(act[i].lower())
